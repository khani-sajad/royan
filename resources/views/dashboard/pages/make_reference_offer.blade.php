<div class="container-fluid">
  <form class="row" action="{{url('reference_offers')}}" method="post" data-card-reader>
    ...
    <fieldset class="form-group col-sm-6">
      <label for="number_of_itroductions">
          معرفی تعداد مشتری
      </label>
      <input value="{{old('number_of_itroductions')}}" type="text" class="form-control" id="number_of_itroductions"  name="number_of_itroductions">
    </fieldset>
    <fieldset class="form-group col-sm-6">
      <label for="min_amount">
          مبلغ خرید
      </label>
      <input value="{{old('min_amount')}}" type="text" class="form-control commo" id="min_amount"  name="min_amount">
    </fieldset>
