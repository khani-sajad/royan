...
<body dir="rtl" class="p-1">
    ...
    <form class="row m-1" action="index.html" method="post">
        ...
        <div class="input-group mb-1">
            <span class="input-group-addon"><i class="fa fa-mars-double fa-fw"></i></span>
            <input class="form-control" name="last_name" type="text" placeholder="تاریخ ازدواج">
        </div>
        <div class="input-group mb-1">
            <span class="input-group-addon"><i class="fa fa-instagram fa-fw"></i></span>
            <input class="form-control" name="last_name" type="text" placeholder="پیج اینستاگرام">
        </div>
        <div class="input-group mb-1">
            <span class="input-group-addon"><i class="fa fa-telegram fa-fw"></i></span>
            <input class="form-control" name="last_name" type="text" placeholder="پیج تلگرام">
        </div>
        <div class="container">
            <div class="my-2 row">
